		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#app01projecthelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"app01projecthelloworld-display": {
								"semanticObject": "app01projecthelloworld",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=app01.projecthelloworld",
									"url": sap.ui.require.toUrl("app01/projecthelloworld")
								}
							}
						}
					}
